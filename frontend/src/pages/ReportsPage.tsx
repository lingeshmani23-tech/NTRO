...
export const ReportsPage: React.FC = () => {
  ...
  if (loading) {
    return <div className="p-8 text-center text-slate-400 text-sm">Loading PDF Report Preview...</div>;
  }
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900 border border-slate-800 p-6 rounded-2xl shadow-xl">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Cryptographic Assessment Report</h1>
              <p className="text-xs text-slate-400">SecureMailScope Official Security Audit Document</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white rounded-xl text-xs font-medium shadow-lg shadow-cyan-600/20 transition-colors flex items-center space-x-1.5"
            >
